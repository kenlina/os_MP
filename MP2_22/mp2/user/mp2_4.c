...
int main(int argc, char *argv[]) {
  ...
  *page2 = 1;
  ...
  for (char *ptr = page1; ptr < page2; ptr += 1) {
    if (*ptr != 0) {
      printf("The content in page1 is not zero\n");
      goto data_error;
    }
  }

  if (*page2 != 1) {
    printf("The first content in page2 is not equal to 1!! The first content is %d\n",*page2);
    goto data_error;
  }
  for (char *ptr = page2 + 1; ptr < page3; ptr += 1) {
    if (*ptr != 0) {
      printf("The content in page2 is not zero\n");
      goto data_error;
    }
  }
  ...
  for (char *ptr = page3; ptr < page3 + PGSIZE; ptr += 1) {
    if (*ptr != 0) {
      printf("The content in page3 is not zero\n");
      goto data_error;
    }
  }
